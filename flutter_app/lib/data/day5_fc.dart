  ...
  static List<TI> getTiArray() {
    return [
      TI(
        ...
        imageAssetPath: 'assets/images/d5_1.png',
      ),
      TI(
        ...
        imageAssetPath: 'assets/images/d5_2.png',
      ),
      TI(
      ...
      TI(
        ...
        imageAssetPath: 'assets/images/d5_3.png',
      ).asHtml(),
      TI(
        text: "두번째 질문이네요. 방을 쪼개는 방법이 있습니다. 다음 그림을 보며 이야기 합시다.",
        imageAssetPath: 'assets/images/d5_4.png',
      ),
      TI(
        ...
        imageAssetPath: 'assets/images/d5_5.png',
      ),
      TI(
        ...
        imageAssetPath: 'assets/images/d5_6.png',
      ...
      TI(
        ...
        imageAssetPath: 'assets/images/d5_9.png',
      ),
      TI(

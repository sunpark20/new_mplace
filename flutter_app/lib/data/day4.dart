  ...
  static List<TI> getTiArray() {
    return [
      TI( //인덱스1
        ...
        imageAssetPath: 'assets/images/d4_1.webp',
      ),
      TI( //인덱스2
        ...
        imageAssetPath: 'assets/images/d4_2.webp',
      ),
      TI( //인덱스3
      ...
      TI( //인덱스7
        text: "<미션> 8분 동안 위의 숫자를 외우자.\n먼저 10개짜리 방으로 이루어진 기억의궁전이 필요하겠네요. day3에서 아카데미 수상작 외웠던걸 떠올려보세요!"
            "다 외우셨다면 다음으로 갑시다.",
        imageAssetPath: 'assets/images/d4_5.webp',
      ).withAlarm(8 * 60),
      TI( //인덱스8
        ...
        imageAssetPath: 'assets/images/d4_b.webp',
      ),
    ];
  }
}

  ...
  static List<TI> getTiArray() {
    return [
      TI( //인덱스1
        ...
        imageAssetPath: 'assets/images/dp_1.webp',
      ),
      TI( //인덱스2
      ...
      TI( //인덱스7
        text: "78: ㅅㅇ -> 성유리 , 04: ㅊㅎ -> 최홍만, 사람(P)과 행동(A)이나 물체(O)을 합쳐서 이미지로 저장합니다.\n"
            ...
            "한번 여러분의 이미지로 바꿔 볼까요?",
        imageAssetPath: 'assets/images/dp_7.webp',
      ),
      TI( //인덱스8
        text: "8분이 지나면 알람을 울려드립니다. 기억의 궁전을 이용해서 다음 숫자를 외워봅시다.",
        imageAssetPath: 'assets/images/dp_8.webp',
      ).withAlarm(8 * 60),
      TI( //인덱스9
        text: "맞추셨나요?? 잘하셨습니다.\n\n"

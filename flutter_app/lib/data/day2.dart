...
class Day2 {
  static List<TI> getTiArray() {
    return [
      ...
      TI(
        text: "성공!! 41.98 N, 127.84 E 는 바로 조선인민공화국 함경북도 량강도 대홍단 감자밭 위경도 였습니다. 샤샤가 감자를 먹고 행복해합니다.",
